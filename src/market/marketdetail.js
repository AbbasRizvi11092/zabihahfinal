...
const marketdetail=({navigation})=> {
  ...
  const alchohol = ()=>{
    if(photo === ""){
      ...
      return(
        <FlatList data={photo} renderItem={({item})=>
    ...
    return (
      <View style={theme == 'light'?styles.container:Darkstyles.container}>
         ...
         <Image source={theme == 'light' ? require('../../img/zabihah.png'):require('../../img/Zabihahblack.png')}  style={{alignSelf:'center',padding:10}}/>
          <MenuIcon name='arrowleft' color={theme=='light'?"black":"white"} size={30} style={{left:0,position:'absolute',alignSelf:'center'}} onPress={()=>navigation.navigate('marketlistview')}/>
          </View>
       ...
       <View style={{backgroundColor:'#FFCC2A',margin:10}}>
                ...
                <Grid style={{margin:5}}>
                    <Row>
                        ...
                        <Col onPress={()=>navigation.navigate('addreviewmarket',{rewiew_data:res_text})}>
                        ...
                        <Col onPress={()=>navigation.navigate('photogalleryMarket',{rest_photo:res_id})}>
                ...
                <Text style={theme == 'light'?styles.online_text:Darkstyles.online_text}>Visit this market online</Text>
              ...
              {review.description_halal?(<View style={{marginTop:10}}>
               ...
               <Text style={theme == 'light'?styles.see_text:Darkstyles.see_text} onPress={()=>navigation.navigate('photogalleryMarket',{rest_photo:res_id})}>
                   See all
               </Text>
              ...
              <View style={{flexDirection:'row',marginTop:10,marginBottom:10}}>
               ...
               <Text style={theme == 'light'?styles.see_text:Darkstyles.see_text} onPress={()=>navigation.navigate('detailreviewmarket',{review_data:res_text})}>
                   See all
               </Text>
               </View>
               <FlatList
