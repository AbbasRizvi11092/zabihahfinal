...
const addreviewmosque=({navigation})=> {
    ...
    const review_add = ()=>{
        if(rating === ""){
            ...
            .post(ServiceConstant.submit_review + "?" + "key" + "=" + ServiceConstant.key + "&" + "uuid" + "=" + ServiceConstant.uuid + "&" + "mid" + "=" + ServiceConstant.user_login_data + "&" + "t" + "=" + 3 + "&" + "id" + "=" + review_text.id + "&" + "rating" + "=" + rating + "&" + "review" + "=" + review + "&" + "rev_spend" + "=" + expense + "&" + "rev_party" + "=" + person + "&" + "rev_return" + "=" + returning)
            .then(function(data){
...
export default addreviewmosque;
