...
const restaurantdetail=({navigation})=> {
  ...
  useEffect(()=>{
    Axios
    .post(ServiceConstant.data_particular_record + "?" + "key" + "=" + ServiceConstant.key + "&" + "uuid" + "=" + ServiceConstant.uuid + "&" + "id" + "=" + res_id + "&" + "l" + "=" + ServiceConstant.user_lat + "," + ServiceConstant.user_long + "&" + "r" + "=" + 10 + "&" + "t" + "=" + 3 )
    .then(function(data){
    ...
    return (
      <View style={theme == 'light'?styles.container:Darkstyles.container}>
         ...
         <Image source={theme == 'light' ? require('../../img/zabihah.png'):require('../../img/Zabihahblack.png')}  style={{alignSelf:'center',padding:10}}/>
          <MenuIcon name='arrowleft' color={theme=='light'?"black":"white"} size={30} style={{left:0,position:'absolute',alignSelf:'center'}} onPress={()=>navigation.navigate('mosquelistview')}/>
          </View>
           ...
           {/* <Text style={{backgroundColor:'#FFCC2A',fontSize:12,margin:5,padding:2,fontWeight:'bold',color:'black'}}>{item.cuisine}</Text> */}
             ...
             <View>  
               ...
               region={{    
                ...
                <Grid style={{margin:5}}>
                    <Row>
                        ...
                        <Col onPress={()=>navigation.navigate('photogalleryMosque',{rest_photo:res_id})}>
                ...
                <Text style={theme == 'light'?styles.online_text:Darkstyles.online_text}>Visit this mosque online</Text>
              ...
              {review.description_halal?(<View style={{marginTop:10}}>
               ...
               <Text style={theme == 'light'?styles.see_text:Darkstyles.see_text} onPress={()=>navigation.navigate('photogalleryMosque',{rest_photo:res_id})}>
                   See all
               </Text>
               </View>
               <FlatList data={photo} horizontal renderItem={({item})=>
              <Image source={{uri:item.photo_url}} style={{width:100,height:70,marginLeft:10}}/>
              }/>
              </View>
                ):null}
               ...
               <Text style={theme == 'light'?styles.see_text:Darkstyles.see_text} onPress={()=>navigation.navigate('detailreviewmosque',{review_data:res_text})}>
                   See all
               </Text>
               </View>
               <FlatList
