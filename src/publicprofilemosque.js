...
const publicprofilemosque=({navigation})=> {
    ...
    return isLoading ? (
      ...
      <View style={theme == 'light'?styles.container:Darkstyles.container}>
         ...
         <Image source={theme == 'light' ? require('../img/zabihah.png'):require('../img/Zabihahblack.png')}  style={{alignSelf:'center',padding:10}}/>
          <MenuIcon name='arrowleft' color={theme=='light'?"black":"white"} size={30} style={{left:0,position:'absolute',marginLeft:13}} onPress={()=>navigation.navigate('profilereviewsmosque')}/>
          </View>
        ...
        <View style={{flexDirection:'row'}}>
            ...
            <Text style={theme == 'light'?style.text_see:Darkstyle.text_see} onPress={()=>navigation.navigate('dashboardmosque',{member_id:res_text})}>
                See all
            </Text>
        </View>
    <FlatList 
...
/>
        ...
        <View style={{flexDirection:'row'}}>
            ...
            <Text style={theme == 'light'?style.text_see:Darkstyle.text_see} onPress={()=>navigation.navigate('profilereviewsmosque')}>
                See all
            </Text>
        </View>
    <FlatList 
...
export default publicprofilemosque;
