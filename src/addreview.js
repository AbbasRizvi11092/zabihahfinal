...
const addreview=({navigation})=> {
    ...
    const review_add = ()=>{
        if(rating === ""){
            ...
            .post(ServiceConstant.submit_review + "?" + "key" + "=" + ServiceConstant.key + "&" + "uuid" + "=" + ServiceConstant.uuid + "&" + "mid" + "=" + ServiceConstant.user_login_data + "&" + "t" + "=" + 1 + "&" + "id" + "=" + review_text.id + "&" + "rating" + "=" + rating + "&" + "review" + "=" + review + "&" + "rev_spend" + "=" + expense + "&" + "rev_party" + "=" + person + "&" + "rev_return" + "=" + returning)
            .then(function(data){
    ...
    return (
      ...
      >
        ...
        <Picker.Item label="NO" value="2" />
          ...
          {/* <Addreviewcard placename ="Choose a rating" onChangeText = {setRating} value = {rating} textholder = "Rating 1 to 5"/>
          <Addreviewcard placename ="How many in your party" onChangeText = {setPerson} value = {person}/>
          <Addreviewcard placename ="How expensive was it?" onChangeText = {setExpense} value = {expense}/>
          <Addreviewcard placename ="Would you return here" onChangeText = {setReturning} value = {returning} textholder = "YES or NO"/> */}
