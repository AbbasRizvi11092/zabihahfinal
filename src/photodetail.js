    ...
    return (
      <View style={theme == 'light'? styles.container:darkstyles.container}>
        ...
        <View style={{flexDirection:'row',alignItems:'center',width:'100%',padding:10}}>
              ...
              <View>
              <Text style={theme == 'light'?styles.name_text:darkstyles.name_text}>{photogallery.photo_name}</Text>
              <Text style={theme == 'light'?styles.text_under:darkstyles.text_under}>{photogallery.photo_date}</Text>
              </View>
