...
const dashboardmarket=({navigation})=> {
    ...
    return (
      ...
      <View style={theme == 'light'?styles.container:stylesDark.container}>
         ...
         <Image source={theme == 'light' ? require('../img/zabihah.png'):require('../img/Zabihahblack.png')}  style={{alignSelf:'center',padding:10}}/>
          <MenuIcon name='arrowleft' color={theme == 'light'?'black':'white'} size={30} style={{left:0,position:'absolute',marginLeft:13}} onPress={()=>navigation.navigate('publicprofilemarket')}/>
          </View>
