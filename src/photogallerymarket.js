...
const photogalleryMarket=({navigation})=> {
    ...
    return (
      <View style={theme == 'light'? styles.container:Darkstyles.container}>
          ...
          <PenIcon name='arrowleft' color={theme=='light'?"black":"white"} size={30} style={{left:0,position:'absolute',marginLeft:13}} onPress={()=>navigation.navigate('marketdetail')}/>
...
export default photogalleryMarket;
