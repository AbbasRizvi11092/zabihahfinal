...
const detailreviewmosque=({navigation})=> {
  const [review,setReview] = useState([])
    ...
    return (
     ...
     style={{width:'100%'}}
     renderItem={({item})=>
     <TouchableOpacity style={theme == 'light'?styles.grid_style:Darkstyles.grid_style} onPress={()=>navigation.navigate('profilereviewsmosque',{member_id:item.member_id})}>
     <Row>
         <Col style={{width:60}}>
...
export default detailreviewmosque;
