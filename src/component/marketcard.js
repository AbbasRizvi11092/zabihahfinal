...
const MarketCard = props =>{
  ...
  useEffect(()=>{
    Axios
    .post(ServiceConstant.record_around_location + "?" + "key" + "=" + ServiceConstant.key + "&" + "uuid" + "=" + 2 + "&" + "id" + "=" + 122 + "&" + "l" + "=" + "51.543227,0.0324407" + "&" + "r" + "=" + 10 + "&" + "t" + "=" + 2)
    .then(function(data){
    ...
    return(
        ...
        <View style={{flexDirection:'row'}}>
            ...
            {JSON.stringify(market_num.number_mark)} {props.textplace}
            </Text>
