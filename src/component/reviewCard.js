    ...
    return(
        ...
        <View style={{flexDirection:'row'}}>
            <Text style={theme == 'light'?styles.text_saved:Darkstyles.text_saved}>
              {main.reviews_total} reviews
            </Text>
            <Text style={theme == 'light'?styles.text_see:Darkstyles.text_see} onPress={()=>this.props.navigation.navigate('profilereviews')}>
                See all
            </Text>
        </View>
    <FlatList 
