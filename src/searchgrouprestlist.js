...
const searchgrouprestlist = ({navigation})=>{
    ...
    return(
        ...
        <View>
            <View style={theme == 'light'?styles.view_normal:Darkstyles.view_normal}>
                ...
                <CrossIcon name='cross' size={35} color={theme == 'light'?'black':'white'} style={{alignSelf:'flex-end',position:'relative',right:0}} onPress={()=>navigation.navigate('restaurantlistview')}/>
                </View>
...
<View>
      ...
      /> 
                 ...
                 <TouchableOpacity onPress={()=>navigation.navigate('restaurantlistview')} style={{backgroundColor:'#990000',marginTop:20,height:45,justifyContent:'center',shadowColor: "#000",
        shadowOffset: {
            width: 0,
            height: 2,
        },
...
export default searchgrouprestlist;